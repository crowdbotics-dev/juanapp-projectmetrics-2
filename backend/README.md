...
## Project Structure
    ...
    ├── juanapp_projectmetrics_2  # Django project configurations
...
1. Clone this repo and `cd juanapp_projectmetrics_2`
...
2. Clone this repo and `cd juanapp_projectmetrics_2`
