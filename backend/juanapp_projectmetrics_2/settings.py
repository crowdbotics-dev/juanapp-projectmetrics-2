"""
Django settings for juanapp_projectmetrics_2 project.
...
ROOT_URLCONF = 'juanapp_projectmetrics_2.urls'
...
WSGI_APPLICATION = 'juanapp_projectmetrics_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juanapp_projectmetrics_2 API",
    "DESCRIPTION": "API documentation for juanapp_projectmetrics_2 App",
    "VERSION": "v1",
}
